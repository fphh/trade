...
type ImpulseGenerator optInput t ohlc = optInput -> OptimizedImpulseGenerator t ohlc

optImpGen2impGen :: OptimizedImpulseGenerator t ohlc -> ImpulseGenerator inp t ohlc
